...
- **Start quickly.** Use the Subscribe starter pills for news sources and popular Reddit communities.
...
2. Use a starter pill to fill a news or Reddit source quickly, then add it like any other subscription.
