<div align="center">
  ...
  <strong>Hide and reorder the sidebar from a dim gripper next to New session.</strong>
  <p>Click the glyph after the Ctrl/N hint to enter edit mode. Click a nav row or session section to turn it off. Drag the grip to reorder with a live gap, the same HTML5 pattern used in Provider Status and RSS Reader.</p>
...
- A dim gripper sits after the New session keyboard hint. Click it to enter edit mode. Click it again, or press Escape, to leave.
