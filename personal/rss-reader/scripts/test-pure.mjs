...
exports.articleMatchesReaderScope = articleMatchesReaderScope;
...
const scopeFeeds = [{ id: "feed-a", folder: "News/AI" }, { id: "feed-b", folder: "News" }, { id: "feed-c", folder: "" }];
assert.equal(fns.articleMatchesReaderScope({ feed_id: "feed-a", is_read: false, is_saved: false }, null, "News", "unread", scopeFeeds), true);
assert.equal(fns.articleMatchesReaderScope({ feed_id: "feed-b", is_read: true, is_saved: false }, null, "News", "unread", scopeFeeds), false);
assert.equal(fns.articleMatchesReaderScope({ feed_id: "feed-b", is_read: false, is_saved: false }, "feed-b", "News", "unread", scopeFeeds), true);
assert.equal(fns.articleMatchesReaderScope({ feed_id: "feed-a", is_read: false, is_saved: false }, "feed-b", "News", "unread", scopeFeeds), false);
assert.equal(fns.articleMatchesReaderScope({ feed_id: "feed-a", is_read: false, is_saved: false }, null, "News", "saved", scopeFeeds), false);
...
assert.deepEqual(fns.pageSlice([{ id: "a" }, { id: "b" }, { id: "c" }, { id: "d" }], 0, 2).map(row => row.id), ["a", "b"]);
assert.deepEqual(fns.pageSlice([{ id: "a" }, { id: "b" }, { id: "c" }, { id: "d" }], 2, 2).map(row => row.id), ["c", "d"]);
assert.deepEqual(fns.pageSlice([{ id: "a" }, { id: "b" }, { id: "c" }, { id: "d" }], 4, 2), []);
