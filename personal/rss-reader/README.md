<div align="center">
  ...
  <p>
    ...
    <a href="plugin.yaml"><img src="https://img.shields.io/badge/version-1.0.6-2ea44f" alt="Version 1.0.6" /></a>
...
```bash
hermes plugins install apoapostolov/hermes-agent-awesome-plugins/personal/rss-reader
```
