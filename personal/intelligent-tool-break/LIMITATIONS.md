...
Personal edition of **Intelligent Tool Break** (`intelligent-tool-break`). This file is why that edition cannot be listed in the Hermes Plugin Catalog as-is.
...
- **Public edition:** removed. Hooks, `/break`, `/again`, and status commands stay.
...
- **Public edition:** no descendant SIGKILL. Hooks relabel the in-flight call.
